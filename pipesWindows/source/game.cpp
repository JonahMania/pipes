...
int runLevel( const char *m )
{
	...
	Timer frameTimer;
	Uint32 timeSinceZoom = 0; 
	Uint32 zoomInterval = 20; //Board zoom speed
	Uint32 timeSinceWater = 0;
	Uint32 timeSinceGlow = 0;
	Uint32 glowInterval = 100; //Exit pipe glow speed
	Uint32 glowWait = 0;
	bool glow = true;
	int pipeCheck = 0;
	int ret = 0;
